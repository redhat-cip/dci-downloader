...
from dci_downloader.certificates import (
...
def test_download_ssl_certificates_dont_call_api_refresh_key_if_cert_exists(
    get_keys_mock,
):
...
def test_download_ssl_certificates_call_api_refresh_key_if_cert_doesnt_exists(
    get_keys_mock,
):
