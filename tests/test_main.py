...
def test_download_one_component_if_component_id():
    ...
    component = {"id": "c1", "name": "RHEL-8.2.0-20191120.0"}
    api.get_components.return_value = [component]
...
def test_download_components_if_no_component_id():
    ...
    topic = {"id": "t1", "name": "RHEL-8"}
    api.get_topic.return_value = topic
    component1 = {"id": "c1", "name": "RHEL-8.2.0-20191120.0"}
    component2 = {"id": "c2", "name": "hwcert-1575558974"}
